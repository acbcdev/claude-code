---
argument-hint: are symlinks to the AGENTS.md file
...
$ARGUMENTS are symlinks to the AGENTS.md file. Review the content of AGENTS.md for contradictions, essentials, and logical groupings.
